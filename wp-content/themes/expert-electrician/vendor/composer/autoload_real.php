...
class Expert_Electrician_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function expert_electrician_loadClassLoader($class)
    {
    ...
    public static function expert_electrician_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
