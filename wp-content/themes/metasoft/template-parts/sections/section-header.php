 ...
 <!-- Main Navigation Start -->
                            ...
                            <div class="main-mobile-menu">
                                ...
                                <div class="menu-collapse-wrap">
                                    <div class="hamburger-menu">
                                        <button type="button" class="menu-collapsed" aria-label="<?php esc_attr_e( 'Menu Collaped', 'metasoft' ); ?>">
                                            <div class="one"></div>
                                            <div class="two"></div>
                                            <div class="three"></div>
                                        </button>
        ...
        <div class="header-search-popup">
            <div class="header-search-flex">
                <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php esc_attr_e( 'Site Search', 'metasoft' ); ?>">
