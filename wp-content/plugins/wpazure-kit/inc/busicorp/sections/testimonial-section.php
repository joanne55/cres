			...
			<section class="section-padding-100 testimonial-section bg-offwhite">
				<div class="container">
					...
					<div class="col-md-6 col-12 mb-30px">
						<div class="testimonial-child-wrap">
						<?php if(!empty($TestiOneDes)){?>
							<div class="testimonial-single-child bg-offwhite radius-5">
			              		<div class="testimonial-text-child">
			              			<p>
						...
						<?php } ?> 
			              	<div class="testimonial-detail-child">
		              			<div class="testimonial-img-child">
		              			...
		              			<?php if(!empty($TestiOneName)){?>
									...
									<div class="testimonial-designation-child"><?php echo esc_html($TestiOneDesi)?></div>
									<?php }?>
		              		</div>
						</div>
					</div>
