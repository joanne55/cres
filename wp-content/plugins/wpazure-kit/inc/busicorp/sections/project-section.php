					...
					<div class="row">
						<div class="col-sm-12 col-12">
							<div class="ce-portfolio">      
								<div class="ce-filters-content-child">
									<div class="row ce-portfolio-grid-child">
										<div class="col-md-4 col-12 project-one">
											<div class="ce-item-child">
												...
												<div class="box-content-child">
													...
													<h4 class="item-title-child"><?php echo esc_html($HomeProjectOneTitle);?></h4>
													<?php } if(!empty($HomeProjectOneDesc))?>
													<span class="ce-des-child"><?php echo esc_html($HomeProjectOneDesc);?></span>
										...
										<div class="col-md-4 col-12 project-two">
											<div class="ce-item-child">
												...
												<div class="box-content-child">
													...
													<h4 class="item-title-child"><?php echo esc_html($HomeProjectTwoTitle);?></h4>
													<?php } if(!empty($HomeProjectTwoDesc))?>
													<span class="ce-des-child"><?php echo esc_html($HomeProjectTwoDesc);?></span>
										...
										<div class="col-md-4 col-12 project-three">
											<div class="ce-item-child">
												...
												<div class="box-content-child">
													...
													<h4 class="item-title-child"><?php echo esc_html($HomeProjectThreeTitle);?></h4>
													<?php } if(!empty($HomeProjectThreeDesc))?>
													<span class="ce-des-child"><?php echo esc_html($HomeProjectThreeDesc);?></span>
												</div>
											</div>
										</div>
									</div>
