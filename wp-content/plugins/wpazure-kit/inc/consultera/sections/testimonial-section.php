			...
			<section class="section-padding-100 testimonial-section bg-offwhite">
				<div class="container">
					...
					<div  class="testimonial-wrapper row">							
						<div id="testtwo1" class="testtwo1 col-md-6 col-12 testimonial-one bg-offwhite radius-5">
						...
						<div id="testtwo2" class="col-md-6 col-12 testimonial-one bg-offwhite radius-5 testtwo2">
