					...
					<div class="col-md-4 col-12 mb-md-0 mb-2">
						<div class="featured-services-child">
							...
							<?php } ?>
								...
								<?php }
								 if(!empty($HomeServiceOneDesc)){ ?>
							    	<p>
										<?php echo esc_html($HomeServiceOneDesc);?>
									</p>
								<?php }
								 if(!empty($HomeServiceOneButtonText)){ ?>
				
										<a href="<?php echo esc_attr($HomeServiceOneButtonLink); ?>" <?php  if($HomeServiceOneButtonTarget == true){echo "target='_blank'";}?> class="read-more-child"><?php echo esc_html($HomeServiceOneButtonText);?> <i class="fa fa-long-arrow-right"></i></a>
						<?php } ?>
							  	</div>
							</div>
						</div>
					...
					<div class="col-md-4 col-12 mb-md-0 mb-2">
						<div class="featured-services-child">
							...
							<?php } ?>
								...
								<?php }
								 if(!empty($HomeServiceTwoDesc)){ ?>
							    	<p>
										<?php echo esc_html($HomeServiceTwoDesc);?>
									</p>
								<?php }
								 if(!empty($HomeServiceTwoButtonText)){ ?>
									
										<a href="<?php echo esc_attr($HomeServiceTwoButtonLink); ?>" <?php  if($HomeServiceTwoButtonTarget == true){echo "target='_blank'";}?> class="read-more-child"><?php echo esc_html($HomeServiceTwoButtonText);?> <i class="fa fa-long-arrow-right"></i></a>
						<?php } ?>
							  	</div>
							</div>
						</div>
					...
					<div class="col-md-4 col-12 mb-md-0 mb-2">
						<div class="featured-services-child">
							...
							<?php } ?>
								...
								<?php }
								 if(!empty($HomeServiceThreeDesc)){ ?>
							    	<p>
										<?php echo esc_html($HomeServiceThreeDesc);?>
									</p>
								<?php }
								 if(!empty($HomeServiceThreeButtonText)){ ?>
									
										<a href="<?php echo esc_attr($HomeServiceThreeButtonLink); ?>" <?php  if($HomeServiceThreeButtonTarget == true){echo "target='_blank'";}?> class="read-more-child"><?php echo esc_html($HomeServiceThreeButtonText);?> <i class="fa fa-long-arrow-right"></i></a>
						<?php } ?>
							  	</div>
							</div>
						</div>
