...
if ( ! function_exists( 'wpazure_kit_consultera_service' ) ) :
	...
	if($HomeServiceEnabled==true){ ?>
		<section class="p-t-150 p-b-100 services-section bg-offwhite">
			<div class="container">
			...
			<?php }?>
				<div class="row">
					...
					<div class="col-md-4 col-12 p-0 services-border-right services-border-bottom">
						<div class="child-3-services">
							<div class="media">
